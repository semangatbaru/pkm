...
class SetujuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root =  inflater.inflate(R.layout.fragment_setuju, container, false)

        list = ArrayList()

        mRecyclerView = root.findViewById(R.id.mRecyclerViewSetuju)
        mRecyclerView.setHasFixedSize(true)
        mRecyclerView.layoutManager = LinearLayoutManager(activity)

        mSwipeRefresh = root.findViewById(R.id.swipeRefreshSetuju)
